            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Quote</span>
                    </div>
                    <div style="text-align:right">
                        <a href="/quote/create" class="btn btn-info btn-sm" style="margin-left:20px;margin-top:10px"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Tambah Quote</h4>
                            </div>
